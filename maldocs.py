...
#		print("\nAttempting to identify risky tags and malformed objects...") << currently not working - written for python 2 only
#		os.system("peepdf.py –fl \""+filename+"\"") << currently not working - written for python 2 only
		...
		print("\nAttempting to locate and list any OLE2 streams present in file and looking for obfuscated URLs in macros...")
